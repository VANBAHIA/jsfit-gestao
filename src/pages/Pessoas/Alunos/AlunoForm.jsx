...
function AlunoForm({ aluno, onSalvar, onCancelar }) {
    ...
    if (aluno) {
      ...
      setFormData({
        ...
        avaliacaoFisica: aluno.avaliacaoFisica ? {
          ...
          altura: formatarAltura(aluno.avaliacaoFisica.altura?.toString()) || '',
          ...
          circunferenciaTorax: aluno.avaliacaoFisica.torax?.toString() || '',
          circunferenciaCintura: aluno.avaliacaoFisica.cintura?.toString() || '',
          circunferenciaQuadril: aluno.avaliacaoFisica.quadril?.toString() || '',
          circunferenciaBracoDireito: aluno.avaliacaoFisica.bracoDireito?.toString() || '',
          circunferenciaBracoEsquerdo: aluno.avaliacaoFisica.bracoEsquerdo?.toString() || '',
          circunferenciaCoxaDireita: aluno.avaliacaoFisica.coxaDireita?.toString() || '',
          circunferenciaCoxaEsquerda: aluno.avaliacaoFisica.coxaEsquerda?.toString() || '',
          circunferenciaPanturrilhaDireita: aluno.avaliacaoFisica.panturrilhaDireita?.toString() || '',
          circunferenciaPanturrilhaEsquerda: aluno.avaliacaoFisica.panturrilhaEsquerda?.toString() || '',
  ...
  const handleAvaliacaoFisicaChange = (campo, valor) => {
    setFormData(prev => {
      ...
      if (campo === 'peso' || campo === 'altura') {
        ...
        if (peso > 0 && altura > 0) {
          ...
          if (campo === 'altura' && altura > 3) {
            novaAvaliacaoFisica.altura = alturaMetros.toFixed(2);
          }
        }
      }
      ...
      return { ...prev, avaliacaoFisica: novaAvaliacaoFisica };
    });
  };
  ...
  const handleSubmit = (e) => {
    ...
    const dadosParaSalvar = {
      ...
      ...(formData.avaliacaoFisica.peso && formData.avaliacaoFisica.altura ? {
        avaliacaoFisica: {
          ...(formData.avaliacaoFisica.id && { id: formData.avaliacaoFisica.id }),
          ...
          imc: formData.avaliacaoFisica.imc ? parseFloat(formData.avaliacaoFisica.imc) : null,
          percentualGordura: formData.avaliacaoFisica.percentualGordura ? parseFloat(formData.avaliacaoFisica.percentualGordura) : null,
          massaMagra: formData.avaliacaoFisica.massaMagra ? parseFloat(formData.avaliacaoFisica.massaMagra) : null,
          massaGorda: formData.avaliacaoFisica.massaGorda ? parseFloat(formData.avaliacaoFisica.massaGorda) : null,
          torax: formData.avaliacaoFisica.circunferenciaTorax ? parseFloat(formData.avaliacaoFisica.circunferenciaTorax) : null,
          cintura: formData.avaliacaoFisica.circunferenciaCintura ? parseFloat(formData.avaliacaoFisica.circunferenciaCintura) : null,
          quadril: formData.avaliacaoFisica.circunferenciaQuadril ? parseFloat(formData.avaliacaoFisica.circunferenciaQuadril) : null,
          bracoDireito: formData.avaliacaoFisica.circunferenciaBracoDireito ? parseFloat(formData.avaliacaoFisica.circunferenciaBracoDireito) : null,
          bracoEsquerdo: formData.avaliacaoFisica.circunferenciaBracoEsquerdo ? parseFloat(formData.avaliacaoFisica.circunferenciaBracoEsquerdo) : null,
          coxaDireita: formData.avaliacaoFisica.circunferenciaCoxaDireita ? parseFloat(formData.avaliacaoFisica.circunferenciaCoxaDireita) : null,
          coxaEsquerda: formData.avaliacaoFisica.circunferenciaCoxaEsquerda ? parseFloat(formData.avaliacaoFisica.circunferenciaCoxaEsquerda) : null,
          panturrilhaDireita: formData.avaliacaoFisica.circunferenciaPanturrilhaDireita ? parseFloat(formData.avaliacaoFisica.circunferenciaPanturrilhaDireita) : null,
          panturrilhaEsquerda: formData.avaliacaoFisica.circunferenciaPanturrilhaEsquerda ? parseFloat(formData.avaliacaoFisica.circunferenciaPanturrilhaEsquerda) : null,
        ...
        <form onSubmit={handleSubmit}>
          <div className="p-6">
            <div className="mb-6">
              ...
              <div className="border-b px-0 bg-gray-50 overflow-x-auto mb-4">
